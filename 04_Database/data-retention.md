...
- **Relationship with Enterprise Records Governance** — `06_Security/data-retention.md` governs the enterprise records layer above this document: organizational accountability, legal hold, cross-functional record domains, and executive oversight. This document remains the authoritative reference for database-level lifecycle mechanics (classification, archival tiering, deletion, anonymization); it does not restate legal hold or executive governance, which are addressed there.
